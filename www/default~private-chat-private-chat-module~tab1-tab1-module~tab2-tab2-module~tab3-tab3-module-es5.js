(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~private-chat-private-chat-module~tab1-tab1-module~tab2-tab2-module~tab3-tab3-module"], {
    ...
    function cpU(module, __webpack_exports__, __webpack_require__) {
      ...
      var ChatData = function ChatData() {
        _classCallCheck(this, ChatData);
      };

      ChatData.ctorParameters = function () {
        return [];
      };

      ChatData = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
      })], ChatData);
      /***/
    },
    ...
    /***/
    function YWyl(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _providers_chatData__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ../providers/chatData */
      "+cpU");
      /* harmony import */
      ...
      var FirestoreService = /*#__PURE__*/function () {
        function FirestoreService(fireStore, authFire, chatData, router) {
        ...
        _createClass(FirestoreService, [{
          ...
          key: "listAllCounters",
          value: function listAllCounters() {
            return this.fireStore.collection('counters').get();
          }
        }, {
          key: "getAsyncUserFields",
          value: function getAsyncUserFields() {
            return this.fireStore.collection('users').doc(this.getUID()).valueChanges();
          }
        }, {
          key: "getChatMessages",
          value: function getChatMessages(chatName) {
          ...
          key: "addUserToChat",
          value: function addUserToChat(chatId, answers) {
            var chatDocRef = this.fireStore.collection('chats').doc(chatId);
            chatDocRef.update({
              users: firebase_app__WEBPACK_IMPORTED_MODULE_2__["default"].firestore.FieldValue.arrayUnion(this.getUID())
            });
            this.chatSubscription.unsubscribe(); //TODO

            if (answers) {
              var sendData1 = {
                data: 'Qual o seu objetivo para daqui 5 anos? ' + answers.target,
                type: 'text'
              };
              var sendData2 = {
                data: 'Qual o seu hobby? ' + answers.hobby,
                type: 'text'
              };
              var sendData3 = {
                data: 'Qual o seu maior sonho ultimamente? ' + answers.dream,
                type: 'text'
              };
          ...
          key: "enterOnGroupChat",
          value: function enterOnGroupChat(chatId, company, answers) {
            var _this2 = this;

            this.getUserInfo().subscribe(function (res) {
              _this2.user = {
                data: res.data(),
                id: res.id
              }; // this.chatSubscription = this.getChatById(chatId);

              _this2.chatData.chat = _this2.getChatById(chatId);
              _this2.chatSubscription = _this2.getChatById(chatId).subscribe(function (chat) {
                if (chat) {
                  _this2.chatData.chatId = chatId;
                  _this2.chatData.user = _this2.user;

                  if (_this2.user.data.chats.filter(function (it) {
                    return it == chatId;
                  }).length == 0) {
                    var userChatRef = _this2.fireStore.collection("users").doc(_this2.user.id);

                    userChatRef.update({
                      chats: firebase_app__WEBPACK_IMPORTED_MODULE_2__["default"].firestore.FieldValue.arrayUnion(chatId)
                    });
                  }

                  _this2.addUserToChat(chatId);
                } else {
                  _this2.chatData.chatId = chatId;
                  _this2.chatData.user = _this2.user;
                  var data = {
                  ...
                  var docRef = _this2.fireStore.collection("chats").doc(chatId);
                  ...
                  docRef.set({
                    ...
                    var doc = _this2.fireStore.collection("users").doc(_this2.user.id);
                    ...
                    doc.update({
                      ...
                      _this2.addUserToChat(chatId, answers);
                    });
                  });
                }
              });
          ...
          key: "exitGroup",
          value: function exitGroup(chatId) {
            var myId = this.getUID();
            this.fireStore.collection('chats').doc(chatId).update({
              users: firebase_app__WEBPACK_IMPORTED_MODULE_2__["default"].firestore.FieldValue.arrayRemove(myId)
            });
            this.fireStore.collection("users").doc(myId).update({
              chats: firebase_app__WEBPACK_IMPORTED_MODULE_2__["default"].firestore.FieldValue.arrayRemove(chatId)
            });
          }
        }, {
          key: "getUserInfo",
          ...
          value: function updateUser(userData) {
            this.fireStore.collection('users').doc(this.getUID()).update(Object.assign({}, userData)).then(function (it) {
              return it;
            });
          }
        }, {
          key: "sendMessage",
          value: function sendMessage(user, chatId, data, payload) {
            data.user = user.id;
            ...
            var docRef = this.fireStore.collection("chats").doc(chatId);
            docRef.update({
              messages: firebase_app__WEBPACK_IMPORTED_MODULE_2__["default"].firestore.FieldValue.arrayUnion(data)
            });
          }
        }]);
...
//# sourceMappingURL=default~private-chat-private-chat-module~tab1-tab1-module~tab2-tab2-module~tab3-tab3-module-es5.js.map